...
| [↗](/files/cosmos/files/euclid-dr1.md#iv-stellar-mass-function-at-z-gtrsim-10) Stellar mass function at $`z \gtrsim 10`$ | JWST-style massive galaxies persist in Euclid wide-area statistics; reachable with $`\varepsilon_\text{SF} \lesssim 1`$ under $`a_0(z{=}10) \approx 20.5\times`$. | Standard ΛCDM galaxy formation predicts the abundance from halo statistics and baryonic star-formation efficiency; the comparison is the ceiling Boylan-Kolchin (2023) derives at full star-formation efficiency (re-registered 2026-09-23; scored on the first qualifying Euclid measurement; the JWST measurements examined lie inside it). | Abundance of $`M_{*} \sim 10^{10}\ M_\odot`$ galaxies at $`z > 10`$ falls within Boylan-Kolchin (2023) ΛCDM SMF forecast at $`\geq 2\sigma`$ |
