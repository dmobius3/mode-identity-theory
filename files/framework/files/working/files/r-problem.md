...
**Type:** Map
**State:** Active
**Status (2026-09-17):** Two live routes to R that do not close on one value: the coupling route pins Ω_Λ (R ≈ 6.1 Gpc, Λ_ref ~23% low) and the mass-spectrum route cross-checks at order of magnitude (R ≈ 10.5-20 Gpc). Whether Λ_ref is the physical Λ is the Interface question. R is also not the only thing between the Molien gap and the sky: the spatial projection is a second, separate missing object.
