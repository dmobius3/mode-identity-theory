...
| ν R1 ladder 0.87 / 7.3 / 66.7 meV (triv/std/gal) | awaiting JUNO/DUNE; ordered proxy resemblance to lightest / solar / atmospheric scales, not hits | proxy only, no generation assignment; splitting ratios 0.72, 1.8 | mass formula (R1) | inverted ordering favored with $`\chi^2_\text{NO} - \chi^2_\text{IO} \geq 9`$ (NuFIT global fit or a successor); the absolute reading is excluded by the splittings |
