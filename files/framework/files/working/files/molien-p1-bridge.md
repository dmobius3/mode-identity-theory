...
## VII. Bearing on other pages (flagged, not edited)

- **CMB Anomalies.** [The page](../../../../cosmos/files/cmb-anomalies.md) says parity and the quadrupole-octupole alignment stay open to this topology through the eigenmode covariance. §II's corollary closes the alignment half conditionally, for a Gaussian source carried to the sky by a map that preserves the observer's A5, and every map on this page does. It leaves parity as it was. Updating that page is a separate step, with a sweep of every place the claim appears.
